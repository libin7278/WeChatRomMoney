...
public class RobMoneyService extends AccessibilityService {
    ...
    private void openPacket() {
        ...
        for(int i = 0 ; i<nodeInfo.getChildCount();i++){
            ...
            Log.e("TAG","child.getViewIdResourceName() : "+child.getViewIdResourceName());
            Log.e("TAG","child.getViewIdResourceName() : "+child.toString());
        ...
        if (nodeInfo != null) {
            ...
            for (AccessibilityNodeInfo n : list) {
                Log.e("TAG","AccessibilityNodeInfo : "+n);
